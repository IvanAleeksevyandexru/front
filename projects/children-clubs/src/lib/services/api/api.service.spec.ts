...
import {
  ...
  DIRECTIONS_SUB_URL, MUNICIPALITIES_SUB_URL
...
describe('ApiService', () => {
  ...
  describe('getProgramList()', () => {
    ...
    it('should call http with post method', fakeAsync(() => {
      service.getProgramList(reqBody).subscribe((response) => expect(response).toBe(responseMock.items));
  ...
  describe('getProgram()', () => {
    ...
    it('should call http with get method and passed params', fakeAsync(() => {
      ...
      const req = http.expectOne(`${PROGRAM_DETAIL_SUB_URL}${uuid}?nextSchoolYear=${nextSchoolUYear}`);
  ...
  describe('getGroupList()', () => {
    ...
    it('should call http with post method', fakeAsync(() => {
      service.getGroupList(uuid, reqBody).subscribe((response) => expect(response).toBe(responseMock.items));
  ...
  describe('getDirections()', () => {
    ...
    it('should call http with get method and passed params', fakeAsync(() => {
      service.getDirections(okato).subscribe((response) => expect(response).toBe(responseMock.items));
  ...
  describe('getMunicipalities()', () => {
    ...
    it('should call http with get method and passed params', fakeAsync(() => {
      service.getMunicipalities(okato).subscribe((response) => expect(response).toBe(responseMock.items));
