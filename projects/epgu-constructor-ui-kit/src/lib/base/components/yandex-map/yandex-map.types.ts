// TODO: избавиться в перспективе в пользу внешних типов
/* eslint-disable @typescript-eslint/no-explicit-any */
/* eslint-disable @typescript-eslint/member-ordering */

import { IFeatureTypes } from './yandex-map.interface';

export declare namespace ymaps {
  ...
  class Clusterer implements IChildOnMap, ICustomizable, IEventEmitter, IParentOnMap {
    ...
    ): { isShown: boolean; cluster: Cluster; isClustered: boolean };
