...
@Component({
  ...
  template: `
    <input type="text" epgu-cf-ui-constructor-text-transform [textTransformType]="all" class="all" />
    <input type="text" epgu-cf-ui-constructor-text-transform [textTransformType]="first" class="first" />
    <input
      type="text"
