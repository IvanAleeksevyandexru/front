...
@Component({
  ...
  templateUrl: './micro-app-component-resolver.component.html',
  styleUrls: ['./micro-app-component-resolver.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush,
  providers: [UnsubscribeService],
})
export class MicroAppComponentResolverComponent implements AfterViewInit, OnDestroy {
