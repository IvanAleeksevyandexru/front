...
describe('DateRangeService', () => {
  ...
  it('should be return min date', async () => {
    ...
    const minDate = await service.getMinDate(componentMock.attrs.ref, componentMock.id, new Date());
  ...
  it('should be return max date', async () => {
    ...
    const maxDate = await service.getMaxDate(componentMock.attrs.ref, componentMock.id, new Date());
