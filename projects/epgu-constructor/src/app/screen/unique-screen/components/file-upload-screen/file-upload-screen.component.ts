...
export class FileUploadScreenComponent {
  ...
  private info: ComponentItem;
  @Input() set data(data: ComponentItem) {
    this.info = data;
    this.allMaxFiles = 0;
    // @ts-ignore
   ...
   */
  getUploadComponentPrefixForMnemonic(componentData: ComponentItem): string {
