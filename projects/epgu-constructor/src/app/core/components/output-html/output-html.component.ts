...
export class OutputHtmlComponent implements OnInit {
  ...
  private toggleHiddenBlockOrShowModal(el: HTMLElement, targetElementId: number) {
  ...
  private startToShowModal(clarifications: Clarifications = {}, targetElementId: number) {
  ...
  showModal(targetClarification: { text?: string }, targetElementId: number) {
