...
import { TimeSlotBirthComponent } from './time-slot-birth.component';
...
describe('TimeSlotBirthComponent', () => {
  let component: TimeSlotBirthComponent;
  let fixture: ComponentFixture<TimeSlotBirthComponent>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(TimeSlotBirthComponent);
