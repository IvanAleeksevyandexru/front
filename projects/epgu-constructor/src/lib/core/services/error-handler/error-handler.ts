...
<span>По выбранной Вами специальности нет доступного времени для записи через Госуслуги. Пожалуйста, обратитесь в регистратуру медицинской организации или попробуйте записаться позже</span>
</div>`;
