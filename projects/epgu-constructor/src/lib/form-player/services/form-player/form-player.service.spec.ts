...
describe('FormPlayerService', () => {
  ...
  describe('getOrderData()', () => {
    ...
    it('should call sendDataError with error response when call getOrderData with error response case', () => {
      ...
      jest
        .spyOn<any, string>(formPlayerApiService, 'getServiceData')
  ...
  describe('navigate()', () => {
    ...
    it('should call updateRequest with prev-button param', () => {
      ...
      service.navigate(testNavigation, FormPlayerNavigation.NEXT);
      expect(service['updateRequest']).toHaveBeenCalledWith(testNavigation);
    });
    ...
    it('should call sendDataError with error response when call navigate with error response case', () => {
      ...
      jest
        .spyOn<any, string>(formPlayerApiService, 'navigate')
        .mockReturnValue(throwError(errorResponse));
      jest.spyOn<any, string>(service, 'sendDataError');
      service.navigate(testNavigation, FormPlayerNavigation.NEXT);
      expect(service['sendDataError']).toHaveBeenCalledWith(errorResponse);
  ...
  describe('getBooking()', () => {
    ...
    it('should call sendDataError with error response when call navigate with error response case', () => {
      ...
      jest
        .spyOn<any, string>(formPlayerApiService, 'getBooking')
        .mockReturnValue(throwError(errorResponse));
      jest.spyOn<any, string>(service, 'sendDataError');
      service.getBooking();
      expect(service['sendDataError']).toHaveBeenCalledWith(errorResponse);
  ...
  describe('initPlayerFromQuiz()', () => {
    ...
    it('should call sendDataError with error response when call navigate with error response case', () => {
      ...
      jest
        .spyOn<any, string>(formPlayerApiService, 'quizToOrder')
        .mockReturnValue(throwError(errorResponse));
      jest.spyOn<any, string>(service, 'sendDataError');
      service.initPlayerFromQuiz(quiz);
      expect(service['sendDataError']).toHaveBeenCalledWith(errorResponse);
  ...
  describe('initPlayerFromOrder()', () => {
    ...
    it('should handle success', (done) => {
      ...
      jest
        .spyOn<any, string>(formPlayerApiService, 'navigate')
        .mockReturnValue(navigateSubject.asObservable());

      service.initPlayerFromOrder({}).subscribe((formPlayerResponse) => {
        expect(formPlayerResponse).toBe(successNavigateResponse);
  ...
  describe('updateRequest()', () => {
    ...
    it('should call isEmptyNavigationPayload with param', () => {
      ...
      service['updateRequest'](testNavigation);
      expect(service['isEmptyNavigationPayload']).toBeCalledWith(testNavigation.payload);
    });
