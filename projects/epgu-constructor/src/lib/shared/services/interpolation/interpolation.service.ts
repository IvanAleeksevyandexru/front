...
export class InterpolationService {
  ...
  public interpolateObject(source: object, variables: object, keepVariables = true): object {
    return Object.entries(source).reduce((result, [key, value]) => {
      result[key] = typeof value === 'string' ? this.interpolateString(value, variables, '', keepVariables) : value;
      return result;
    }, {});
  }

  public interpolateString(stringWithVariables: string, variables: object, defaultValue: string = '', keepVariables = true): string {
