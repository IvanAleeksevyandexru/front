...
export class ValidationService {
  ...
  private checkMIRCardBins(cardNumber: string): boolean {
    ...
    const binRegExp = /^((2200\s?0[1-9])|(2200\s?1[013-9])|(2200\s?2[0-9])|(2200\s?3[0-47-9])|(2200\s?4[0235789])|(2200\s?5[02-689])|(2200\s?6[0-24-79])|(2200\s?7[01346-8])|(2200\s?8[02-479])|(2200\s?9[1-35-9])|(2201\s?0[0468])|(2201\s?1[023679])|(2201\s?2[023579])|(2201\s?3[0346])|(2201\s?4[02-46-9])|(2201\s?5[03-9])|(2201\s?6[125-79])|(2201\s?7[0289])|(2201\s?8[14-8])|(2201\s?9[569])|(2202\s?1[0247])|(2202\s?2[018])|(2202\s?3[169])|(2202\s?49)|(2202\s?5[35-9])|(2202\s?7[489])|(2203\s?2[2459])|(2203\s?3[19])|(2203\s?4[14])|(2203\s?51)|(2203\s?74)|(2203\s?8[13])|(2204\s?15)|(2204\s?88)|(3562\s?99)|(3565\s?(04|14|46))|(6234\s?46)|(6291\s?(29|57))|(6292\s?44)|(6711\s?82)|(6763\s?47)|(6764\s?54)|(6765\s?31)|(6768\s?84)|(6769\s?7)|(6773\s?(19|84)))[0-9]{2}\s?[0-9]{4}\s?([0-9]{4}\s?([0-9]|[0-9]{2}|[0-9]{3})?)$/;
